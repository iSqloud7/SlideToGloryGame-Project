# stats.py - Statistics system for Snake and Ladder Game
...
if __name__ == "__main__":
    ...
    # Create a test user
    stats = StatsManager("test_user")

    # Record some test games
    stats.record_game(True, 120)  # Win in 2 minutes
    stats.record_game(False, 180)  # Loss in 3 minutes
    stats.record_game(True, 90)  # Win in 1.5 minutes

    # Display stats
    display = stats.get_display_stats()
    print("\nCurrent Statistics:")
    for key, value in display.items():
        print(f"{key}: {value}")

    print("\nStatistics system test complete!")